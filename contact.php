...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.icssdda@gmail.com';
    $mail->Password   = 'ygun bloi cibv mbsg'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.icssdda@gmail.com', 'ICSSDDA Enquiry');
    $mail->addAddress('info.icssdda@gmail.com', 'ICSSDDA Enquiry');
    ...
    $replyMail->Username   = 'info.icssdda@gmail.com';
    $replyMail->Password   = 'ygun bloi cibv mbsg';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.icssdda@gmail.com', 'ICSSDDA Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICSSDDA 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICSSDDA 2025 Team</p>
        </div>
    ';
